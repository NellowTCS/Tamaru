...
- [ ] Fix WebKit (yes you iOS) not listening to my "Don't add scrollbars"
- [ ] Better demo
- [ ] Make the fade in/out for rolling much more realistic
- [ ] Tweak base config until it's *perfect*
- [ ] Make rolling less grate-y more roll-y
